...
namespace Avo.SoftDev.Persistance
{
    public static class FakeData
    {
        public static List<TimeRecord> employees = new List<TimeRecord>()
            {
                ...
                new TimeRecord(DateTime.Now.Date.AddDays(-3),"Петров",8,"ттт"),
                new TimeRecord(DateTime.Now.Date.AddDays(-2),"Иванов",10,"ттт"),
                new TimeRecord(DateTime.Now.Date.AddDays(-2),"Петров",8,"ттт")
            };
        ...
        {
            new TimeRecord(DateTime.Now.Date.AddDays(-3),"Смит",8,"ттт"),
            new TimeRecord(DateTime.Now.Date.AddDays(-3),"Бонд",8,"ттт"),
            new TimeRecord(DateTime.Now.Date.AddDays(-2),"Смит",10,"ттт"),
            new TimeRecord(DateTime.Now.Date.AddDays(-2),"Бонд",8,"ттт")
        };

        public static List<TimeRecord> managers = new List<TimeRecord>()
        {
            new TimeRecord(DateTime.Now.Date.AddDays(-3),"Аво",8,"ттт"),
            new TimeRecord(DateTime.Now.Date.AddDays(-2),"Аво",8,"ттт"),
        };
    }
}
